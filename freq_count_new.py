...
if __name__ == "__main__":
    m = FreqCountCore(6, 32)
    # print(m.clock_domains.cd_sys)
    with open("freq_count3.v", "w") as f:
        f.write(str(verilog.convert(m, {m.cd_src.clk, m.cd_dest.clk, m.cd_dest.rst, m.count_curr, m.count_latched, m.latch})))
